...
const itemBaseData = {
    ...
    "Noble Estate": { name: "Noble Estate", expense: 25000, effect: 12, heromult: 4, heroeffect: 2e11 },
    "Grand Palace": { name: "Grand Palace", expense: 300000, effect: 25, heromult: 5, heroeffect: 2e12 },
    "Blessed Imperial Dwelling": { name: "Blessed Imperial Dwelling", expense: 5000000, effect: 60, heromult: 5, heroeffect: 2e13 },
    "Auspicious Cultivator Dwelling": { name: "Auspicious Cultivator Dwelling", expense: 35000000, effect: 120, heromult: 6, heroeffect: 2e15 },
    "Dragon Vein Confluence Cavern": { name: "Dragon Vein Confluence Cavern", expense: 1.1e9, effect: 500, heromult: 7, heroeffect: 2e17 },
    "Starlight Converging Peak": { name: "Starlight Converging Peak", expense: 1.3e10, effect: 1200, heromult: 8, heroeffect: 2e19 },
    ...
    "Fivefold Elements Ring": { name: "Fivefold Elements Ring", expense: 2.8e10, effect: 3, description: "Dao Comprehension XP", heromult: 10, heroeffect: 10 },
    "Golden Petal Robe": { name: "Golden Petal Robe", expense: 1.97e11, effect: 3, description: "Dao Comprehension XP", heromult: 10, heroeffect: 10 },
    "Demon Slaying Blade": { name: "Demon Slaying Blade", expense: 5e11, effect: 3, description: "Skill XP", heromult: 11, heroeffect: 10 },
...
const requirementsBaseData = {
    ...
    "Noble Estate": new CoinRequirement([getQuerySelector("Noble Estate")], [{ requirement: itemBaseData["Noble Estate"].expense * 100 }]),
    "Grand Palace": new CoinRequirement([getQuerySelector("Grand Palace")], [{ requirement: itemBaseData["Grand Palace"].expense * 100 }]),
    "Blessed Imperial Dwelling": new CoinRequirement([getQuerySelector("Blessed Imperial Dwelling")], [{ requirement: itemBaseData["Blessed Imperial Dwelling"].expense * 100 }]),
    "Auspicious Cultivator Dwelling": new CoinRequirement([getQuerySelector("Auspicious Cultivator Dwelling")], [{ requirement: itemBaseData["Auspicious Cultivator Dwelling"].expense * 100 }]),
    "Dragon Vein Confluence Cavern": new CoinRequirement([getQuerySelector("Dragon Vein Confluence Cavern")], [{ requirement: itemBaseData["Dragon Vein Confluence Cavern"].expense * 100 }]),
    "Starlight Converging Peak": new CoinRequirement([getQuerySelector("Starlight Converging Peak")], [{ requirement: itemBaseData["Starlight Converging Peak"].expense * 100 }]),
    ...
    "Fivefold Elements Ring": new CoinRequirement([getQuerySelector("Fivefold Elements Ring")], [{ requirement: itemBaseData["Fivefold Elements Ring"].expense * 100 }]),
    "Golden Petal Robe": new CoinRequirement([getQuerySelector("Golden Petal Robe")], [{ requirement: itemBaseData["Golden Petal Robe"].expense * 100 }]),
    "Demon Slaying Blade": new CoinRequirement([getQuerySelector("Demon Slaying Blade")], [{ requirement: itemBaseData["Demon Slaying Blade"].expense * 100 }]),
...
const xianxiaDisplayNames = {
    ...
    "Pact with the Heavens": "Pact with the Heavens",
    "Ascendant Master": "Ascendant Master",
    "Eternal Time": "Eternal Cycle",
    "Celestial Conduit": "Celestial Conduit",
    "Divine Meridians": "Divine Meridians",
    "Heaven's Blessing": "Heaven's Blessing",
    "Cumulative Fortune": "Cumulative Fortune",
...
//    "Ascendant Master": "Your understanding of ascension refines spirit essence itself.",
//    "Celestial Conduit": "A Celestial Conduit opens and demonic qi leaks endlessly into your path.",
//    "Heaven's Blessing": "Heavenly fortune shields your progress through rebirth.",
//    "Cumulative Fortune": "A tiny spark of Dao persists and grows with every cycle.",
