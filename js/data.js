...
const xianxiaDisplayNames = {
    "Beggar": "Mortal Drifter",
    "Farmer": "Spirit Herb Farmer",
    "Fisherman": "River Disciple",
    "Miner": "Spirit Stone Miner",
    "Blacksmith": "Artifact Smith",
    "Merchant": "Traveling Caravan Elder",
    "Squire": "Outer Sect Attendant",
    "Footman": "Sect Guard",
    "Veteran footman": "Elite Sect Guard",
    "Centenary": "Formation Captain",
    "Knight": "Core Disciple",
    "Veteran Knight": "Inner Court Elder",
    "Holy Knight": "Nascent Soul Protector",
    "Lieutenant General": "Grand Marshal Patriarch",
    "Student": "Qi Initiate",
    "Apprentice Mage": "Spirit Art Apprentice",
    "Adept Mage": "Foundation Cultivator",
    "Master Wizard": "Golden Core Master",
    "Archmage": "Nascent Soul Sage",
    "Chronomancer": "Time Dao Adept",
    "Chairman": "Sect Grand Elder",
    "Imperator": "Heavenly Sovereign",
    "Corrupted": "Qi-Deviant",
    "Void Slave": "Abyss Servant",
    "Void Fiend": "Void Revenant",
    "Abyss Anomaly": "Abyss Aberration",
    "Void Wraith": "Void Shade",
    "Void Reaver": "Rift Reaver",
    "Void Lord": "Void Monarch",
    "Abyss God": "Abyss Immortal",
    "Eternal Wanderer": "Realm Wanderer",
    "Nova": "Starfire Immortal",
    "Sigma Proioxis": "Heaven-Piercing Exalt",
    "Acallaris": "Primordial Ancestor",
    "One Above All": "Dao Ancestor",
    "Snow Crash": "Frostfall Sentinel",
    "Player One": "First Ascendant",
    "Lost in the dark": "Lost in Samsara",
    "Omega": "Final Tribulation",
...
const xianxiaCategoryNames = {
    "Common work": "Mortal Paths",
    "Military": "Martial Sect",
    "The Arcane Association": "Heavenly Dao Academy",
