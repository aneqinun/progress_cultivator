...
const milestoneBaseData = {
    ...
    "Deal with the Devil": { name: "Deal with the Devil", expense: 30000, tier: 3, description: "Passively gain a small amount of Demonic Qi" },
    ...
    "Hell Portal": { name: "Hell Portal", expense: 120000, tier: 6, description: "Passively gain a huge amount of Demonic Qi" },
    "Inferno": { name: "Inferno", expense: 170000, tier: 7, description: "x5 Demonic Qi gain" },
    "God's Blessings": { name: "God's Blessings", expense: 250000, tier: 8, description: "x10M Happiness, keep Demonic Perks on reset" },
    ...
    "Scared Heroes": { name: "Scared Heroes", expense: 150000000, tier: 16, description: "Ascendant Cultivator & Skill XP, new Demonic Perk", effect: 1e15 },
    ...
    "Dark Orbiter": { name: "Dark Orbiter", expense: 1e22, tier: 28, description: "Multiply Nether Orb gain by 1e10x, keep four Demonic Perks always" },
    ...
    "The Devil inside you": { name: "The Devil inside you", expense: 1e35, tier: 31, description: "Multiply Demonic Qi gain by 1e15x" },
