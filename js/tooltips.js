const tooltips = {
    ...
    // Residences
    "Ragged Courtyard": "A crumbling structure long-abandoned by another. Highly uncomfortable; you are exposed to the elements.",
    "Bamboo Hut": "A simple, swaying shelter. Poorly insulated, but it keeps the rain off.",
    "Mountain Cottage": "A humble dwelling perched on high ridges. Sturdy and warm, however it is very remote.",
    "Respectable Home": "A sturdy residence structured with a timber frame and a thatched roof.",
    "Stately Manor": "A walled compound housing a master whose influence dictates the prosperity of the surrounding valley.",
    "Noble Estate": "A sprawling complex of gardens and halls where your family line begins its dynasty.",
    "Grand Palace": "A golden monument to earthly power, serving as a seat of immense authority.",
    "Blessed Imperial Dwelling": "A sanctum wreathed in the purple Qi of kingship, where the mandate of heaven is physically felt.",
    "Auspicious Cultivator Dwelling": "A site specifically chosen for its spiritual alignment, optimized for the gathering of gaseous Qi.",
    "Dragon Vein Confluence Cavern": "A cave carved directly into the junction of the earth’s primal energy lines, overflowing with liquid essence.",
    "Starlight Converging Peak": "A summit so high it bathes in the unfiltered glow of the cosmos, refining the spirit with astral fire.",
    "Century Refinement Holy Forest": "A living ecosystem where every leaf and blade of grass has been tempered by a hundred years of your aura.",
    "Taiji Cycling Blessed Land": "A localized paradise where the laws of Yin and Yang rotate in perfect, visible harmony.",
    "Earth Overturning Grotto Heaven": "An entire hidden world folded into the geography, boasting its own sky and self-contained laws.",
    "Star-Plucking Tower": "A spire that pierces the world’s boundary, serving as a lookout for those ready to leave the earth behind.",
    "Star-Stepping Turtle Dwelling": "A colossal, ancient beast that carries your home upon its back through the silent vacuum of space.",
    ...
    "Spiritual Sun": "You reside within a star itself, using its nuclear fusion as the hearth for your eternal cultivation.",
    "Rice-Grain Realm": "A complete solar system condensed into a microscopic speck, allowing you to carry billions of souls in your palm.",
    "Realm Prefecture": "You govern an entire plane of existence, where every mountain and sea is a mere room in your house.",
    ...
    "The Akashic Library": "A shoreless archive of information where you dwell among the records of every thought ever conceived.",
    "The Karmic Pool": "A tranquil pond where you sit and fish for the consequences of a trillion lives, reeling in the debts of gods.",
